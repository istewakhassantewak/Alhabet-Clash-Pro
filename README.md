...
A random alphabet will appear on the screen
Press the matching key on your keyboard
Correct answers increase your score
Wrong or missed keys reduce life points
Try to achieve the highest score before time ends

📌 Project Highlights
Fun and engaging typing practice game
DOM manipulation with JavaScript
Real-time event handling and game logic
